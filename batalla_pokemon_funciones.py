...
while items_jugador[0] > 0 and items_oponentes[0] > 0:
    ...
    if items_oponentes[1] <= 10:
        ...
        def placaje(items_oponentes, diccionario_ataque):
    ...
    def ataque_oponente(ataque_oponente, items_jugador, diccionario_ataque):
        ...
        if items_jugador[1] <= 0:
            ...
            items_jugador = items_jugador[0] - 35 * (100/items_jugador[1]), items_jugador[1] - 10
        ...
        print("Tu enemigo ha usado pistola de agua, tu vida es ahora:")
